...
import org.dimigo.action.TransListAction;

@WebServlet("/translist")
public class TransListActionServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	public TransListActionServlet() {
		super();
	}

	@Override
	public void init() throws ServletException {
		actions.put("translist", new TransListAction());
	}
