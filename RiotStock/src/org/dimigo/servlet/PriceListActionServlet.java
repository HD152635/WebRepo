...
import org.dimigo.action.PriceListAction;
import org.dimigo.action.StockListAction;

@WebServlet("/pricelist")
public class PriceListActionServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	public PriceListActionServlet() {
		super();
	}

	@Override
	public void init() throws ServletException {
		actions.put("pricelist", new PriceListAction());
	}
